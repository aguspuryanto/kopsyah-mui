...
import { Receipt, CheckCircle, Clock, Calculator, Info, Landmark } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="bg-white px-6 pt-12 pb-6 shadow-sm border-b border-gray-100 flex items-center gap-3 sticky top-0 z-30">
        ...
        <div>
          <h1 className="text-xl font-heading font-bold text-gray-900">Pembiayaan</h1>
          <p className="text-xs text-gray-500">Murabahah, Ijarah, Musyarakah</p>
        </div>
      </div>
